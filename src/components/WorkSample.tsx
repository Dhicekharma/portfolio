...
function WorkSample() {
  return (
    ...
    <div className=" grid  lg:grid-cols-5 gap-y-9 md:grid-cols-3 sm:grid-cols-2 h-fit w-fit py-5 gap-10  m-auto">
      ...
      <Link
        className=" w-36 mt-11 border-based rounded-lg inline-flex text-based font-bold tracking-wider justify-center items-center
    ...
    <div className=" bg-greay-300 grid  lg:grid-cols-4 gap-y-9 md:grid-cols-2 sm:grid-cols-1 h-fit py-5  ">
