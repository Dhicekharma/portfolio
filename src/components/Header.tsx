...
function Header() {
  ...
  return (
    <div className=" flex fixed  top-0 left-0 px-10 py-6 items-center z-50 justify-between bg-background w-full ">
      ...
      <Link className="transition duration-700 ease-in-out  text-lg  ml-11 font-bold hover:text-slate-500 " to="/Contacts">
        Contacts
      </Link>
