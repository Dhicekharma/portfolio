    ...
    <div className="">
      <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
        ...
        <footer className="dark:bg-gray-800 dark:text-gray-50">
          <div className="container flex flex-col p-4 mx-auto md:p-8 l divide-gray-400">
            <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
              {/* Quick Links*/}
              <Link className=" hover:text-based" to=""> About us</Link>
              <Link className=" hover:text-based" to="">testimonial</Link>
              <Link className=" hover:text-based" to="">terms of service</Link>
              <Link className=" hover:text-based" to=""> Blog</Link>
              <Link className=" hover:text-based" to="">Contact</Link>
            </ul>
